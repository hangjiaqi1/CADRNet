...
If you use CADRNet or Multi-Scan in your research, please cite:

```bibtex
@inproceedings{cadrnet2024,
...
- **ScanNet Team**: Multi-Scan builds upon the ScanNet dataset. Please cite the original ScanNet paper when using this dataset.
- **Active Vision Research Community**: Inspired by cognitive vision theories and human perception mechanisms
- **Funding Support**: This work was supported by [Funding Information]

## 📞 Contact & Support

For questions, technical issues, or collaboration opportunities:
...
**Important**: ScanNet has its own license terms. Ensure compliance with ScanNet's terms of use when using Multi-Scan.

---

**🌟 Star this repository to follow our three-phase open-source release schedule and stay updated on CADRNet developments!**